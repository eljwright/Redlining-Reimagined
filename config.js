...
//   2. Chapter Six a had two images stored in the same directory as this file. I've placed them in images folder and rewritten this into the chapter  
  chapters: [
    ...
    },
    {
      ...
      image: "",
      description:
        'One way housing discrimination occurred in Seattle was through the Homeowners Loan Corporation (HOLC). The HOLC, saying they were worried about taking on risky loans, made color-coded maps to assess the riskiness of granting home loans in different neighborhoods. These maps were created for every major American city, including Seattle in 1936. The maps included four different residential grades that neighborhoods would be ranked into. <br><br>These residential grades were as follows:<br><span style="display:inline-block; width:15px; height:15px; background-color: #588c73; border: 1px solid #588c73; vertical-align:middle; margin-right:5px;"></span><strong>A. Best</strong> (Green areas on the map)<br><span style="display:inline-block; width:15px; height:15px; background-color: #52749A; border: 1px solid #52749A; vertical-align:middle; margin-right:5px;"></span><strong>B. Still Desirable</strong> (Blue areas on the map)<br><span style="display:inline-block; width:15px; height:15px; background-color: #f5d56c; border: 1px solid #f5d56c; vertical-align:middle; margin-right:5px;"></span><strong>C. Definitely Declining</strong> (Yellow areas on the map)<br><span style="display:inline-block; width:15px; height:15px; background-color: #b86a5f; border: 1px solid #b86a5f; vertical-align:middle; margin-right:5px;"></span><strong>D. Hazardous</strong> (Red areas on the map)<br><br>After these maps were created, they were adopted by the FHA as well as private banks to inform their decisions on who to lend to. This meant that families and individuals in the C and D graded neighborhoods (Yellow and Red respectively) would be systematically denied home loans, which is where the term redlining comes from.',
      location: {
